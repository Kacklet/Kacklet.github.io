package lol.magmaclient.utils.rotation;
...
public class RotationUtils
{
    ...
    public static Rotation getClosestRotation(final AxisAlignedBB aabb) {
        return getRotations(getClosestPointInAABB(Magma.mc.thePlayer.getPositionEyes(1.0f), aabb));
    }
    ...
    public static Rotation getScaffoldRotations(final BlockPos position) {
        ...
        final double x = position.getX() - Magma.mc.thePlayer.posX - posX;
        final double y = position.getY() - Magma.mc.thePlayer.prevPosY - Magma.mc.thePlayer.getEyeHeight();
        final double z = position.getZ() - Magma.mc.thePlayer.posZ - posZ;
    ...
    public static Rotation getRotations(final double posX, final double posY, final double posZ) {
        final double x = posX - Magma.mc.thePlayer.posX;
        final double y = posY - (Magma.mc.thePlayer.posY + Magma.mc.thePlayer.getEyeHeight());
        final double z = posZ - Magma.mc.thePlayer.posZ;
    ...
    public static Rotation getLastReportedRotation() {
        return new Rotation(((PlayerSPAccessor) Magma.mc.thePlayer).getLastReportedYaw(), ((PlayerSPAccessor) Magma.mc.thePlayer).getLastReportedPitch());
    }

    public static Rotation getPlayerRotation() {
        return new Rotation(Magma.mc.thePlayer.rotationYaw, Magma.mc.thePlayer.rotationPitch);
    }
    ...
    public static Rotation getBowRotation(final Entity entity) {
        ...
        double d = Magma.mc.thePlayer.getDistanceToEntity(entity);
        d -= d % 0.8;
        final double xMulti = d / 0.8 * xDelta;
        final double zMulti = d / 0.8 * zDelta;
        final double x = entity.posX + xMulti - Magma.mc.thePlayer.posX;
        final double z = entity.posZ + zMulti - Magma.mc.thePlayer.posZ;
        final double y = Magma.mc.thePlayer.posY + Magma.mc.thePlayer.getEyeHeight() - (entity.posY + entity.getEyeHeight());
        final double dist = Magma.mc.thePlayer.getDistanceToEntity(entity);
