...
public class PacketUtils {
    ...
    {
        Magma.mc.getNetHandler().getNetworkManager().sendPacket(packet);
    }
    ...
    public static void sendPacketNoEvent(final Packet<?> packet) {
        ...
        Magma.mc.getNetHandler().getNetworkManager().sendPacket((Packet)packet);
    }
