...
import lol.magmaclient.modules.render.TargetDisplay;
...
public class TargetHud extends DraggableComponent
{
    ...
    public TargetHud() {
        ...
        this.setPosition(Magma.targetDisplay.x.getValue(), Magma.targetDisplay.y.getValue());
        MinecraftForge.EVENT_BUS.register((Object)this);
    }

    @Override
    public HudVec drawScreen() {
        return this.drawScreen((EntityLivingBase)((KillAura.target == null && Magma.mc.currentScreen instanceof GuiChat) ? Magma.mc.thePlayer : KillAura.target));
    }
    ...
    public HudVec drawScreen(final EntityLivingBase entity) {
        ...
        if (TargetHud.lastEntity != null) {
            ...
            if (Magma.mc.currentScreen instanceof GuiChat && this.isHovered()) {
                ...
                if(Magma.targetDisplay.outline.isEnabled()) {
                    RenderUtils.drawBorderedRoundedRect((float)x, (float)y, 150.0f, 50.0f, 5.0f, 2.5f, new Color(21, 21, 21, 52).getRGB(), Magma.themeManager.getSecondaryColor().getRGB());
                } else {
                    RenderUtils.drawRoundedRect2(x, y, 150.0, 50.0, 5.0, new Color(21, 21, 21, 52).getRGB());
                }
            }
            Fonts.getPrimary().drawSmoothStringWithShadow(ChatFormatting.stripFormatting(TargetHud.lastEntity.getName()), x + 5.0, y + 6.0, Magma.clickGui.getColor(0).brighter().getRGB());
            ...
            Fonts.getSecondary().drawSmoothStringWithShadow((int)(TargetHud.lastEntity.getDistanceToEntity((Entity) Magma.mc.thePlayer) * 10.0f) / 10.0 + "m", x + 5.0, y + 11.0 + Fonts.getSecondary().getHeight(), new Color(231, 231, 231).getRGB());
            ...
            if (hp > 0.05) {
                RenderUtils.drawRoundedRect(x + 10.0, y + 42.0, x + 140.0f * hp, y + 46.0, 2.0, Magma.clickGui.getColor(0).getRGB());
            }
        ...
        Magma.targetDisplay.x.set(this.x);
        Magma.targetDisplay.y.set(this.y);
