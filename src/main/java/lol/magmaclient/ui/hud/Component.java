package lol.magmaclient.ui.hud;
...
public class Component
{
    ...
    protected static int getMouseX() {
        return Mouse.getX() * getScaledResolution().getScaledWidth() / Magma.mc.displayWidth;
    }

    protected static int getMouseY() {
        final int height = getScaledResolution().getScaledHeight();
        return height - Mouse.getY() * height / Magma.mc.displayHeight - 1;
    }

    protected static ScaledResolution getScaledResolution() {
        return new ScaledResolution(Magma.mc);
    }
