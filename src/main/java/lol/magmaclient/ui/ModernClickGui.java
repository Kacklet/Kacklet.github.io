...
public class ModernClickGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        ScaledResolution sr = new ScaledResolution(Magma.mc);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        switch(Magma.clickGui.blur.getSelected()) {
            case "Low":
        ...
        RenderUtils.drawBorderedRoundedRect((float) getX() - 5, (float) getY() - 5, getWidth() + 10, getHeight() + 10, 3.0f, 2 , Magma.themeManager.getPrimaryColor().getRGB(), Magma.themeManager.getSecondaryColor().getRGB());
        RenderUtils.drawBorderedRoundedRect((float)getX(), (float)getY(), 85.0f, getHeight(), 3.0f, 2.0f, Magma.themeManager.getPrimaryColor().getRGB(), Magma.themeManager.getSecondaryColor().getRGB());
        RenderUtils.drawBorderedRoundedRect((float)(getX() + 90.0), (float)getY(), getWidth() - 90.0f, 20.0f, 3.0f, 2.0f, Magma.themeManager.getPrimaryColor().getRGB(), Magma.themeManager.getSecondaryColor().getRGB());
        RenderUtils.drawBorderedRoundedRect((float)(getX() + 90.0), (float)(getY() + 25.0), getWidth() - 90.0f, getHeight() - 25.0f, 3.0f, 2.0f, Magma.themeManager.getPrimaryColor().getRGB(), Magma.themeManager.getSecondaryColor().getRGB());
        Fonts.getSecondary().drawCenteredString("Magma", (float)(getX() + 42.5), (float)(getY() + 6.0), Color.WHITE.getRGB());
        ...
        for (Window window : this.windowManager.windows) {
            ...
            if(window.getName().equals("Settings")) {
                if (window == selectedWindow) {
                    RenderUtils.drawBorderedRoundedRect((float)(getX() + 5.0), (float)(getY() + (double)settingsOffset + 3.0), 75.0f, 12.0f, 4.0f, 4.0f, Magma.themeManager.getSecondaryColor().getRGB(), Magma.themeManager.getSecondaryColor().getRGB());
                }
                Fonts.getPrimary().drawStringWithShadow(window.getName(), getX() + 12.0, getY() + (double)settingsOffset + 5.0, Color.WHITE.getRGB());
            } else {
                if (window == selectedWindow) {
                    RenderUtils.drawBorderedRoundedRect((float)(getX() + 5.0), (float)(getY() + (double)categoryOffset + 3.0), 75.0f, 12.0f, 4.0f, 4.0f, Magma.themeManager.getSecondaryColor().getRGB(), Magma.themeManager.getSecondaryColor().getRGB());
                }
            ...
            RenderUtils.drawBorderedRoundedRect((float)ModernClickGui.getX() + 88.0f, (float)ModernClickGui.getY() + 25.0f, ModernClickGui.getWidth() - 88.0f, ModernClickGui.getHeight() - 25.0f, 6.0f, 2.0f, Magma.themeManager.getPrimaryColor().getRGB(), Magma.themeManager.getPrimaryColor().getRGB());
    ...
    public void onGuiClosed() {
        ...
        Magma.clickGui.setToggled(false);
    }
