package lol.magmaclient.ui.notifications;

import lol.magmaclient.Magma;
import lol.magmaclient.managers.NotificationManager;
...
public class Notification
{
    ...
    public enum NotificationType
    {
        ...
        public Color getColor(final int i) {
            return (this == NotificationType.INFO) ? Magma.themeManager.getSecondaryColor(i) : this.color;
        }
    }
}
