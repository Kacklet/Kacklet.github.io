...
public class AutoClicker extends Module
{
    ...
    public void assign()
    {
        Magma.autoClicker = this;
    }

    @SubscribeEvent
    public void onTick(final RenderWorldLastEvent event) {
        if (this.isToggled() && Magma.mc.thePlayer != null && this.isPressed() && !Magma.mc.thePlayer.isUsingItem() && Magma.mc.currentScreen == null && this.timer.hasTimePassed((long)(1000.0 / this.nextDelay))) {
            this.timer.reset();
    ...
    public boolean isPressed() {
        ...
        switch (selected) {
            ...
            default: {
                return Magma.mc.gameSettings.keyBindAttack.isKeyDown();
            }
        }
    }
