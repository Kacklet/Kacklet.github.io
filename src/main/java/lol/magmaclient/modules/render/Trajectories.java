...
public class Trajectories extends Module {
    ...
    public void assign()
    {
        Magma.trajectories = this;
    }

    @SubscribeEvent
    public void onRenderWorld(RenderWorldLastEvent e) {
        if (!this.isToggled() || Magma.mc.thePlayer == null || Magma.mc.theWorld == null) return;
        if (!(Magma.mc.thePlayer.isUsingItem() && Magma.mc.thePlayer.getHeldItem().getItem() instanceof ItemBow)) return;
        ...
        RenderManager renderManager = Magma.mc.getRenderManager();
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            if (Magma.mc.theWorld.rayTraceBlocks(playerVector, new Vec3(arrowPosX, arrowPosY, arrowPosZ)) != null)
                break;
        }
        GL11.glEnd();
