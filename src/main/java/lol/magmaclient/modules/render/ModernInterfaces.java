...
import lol.magmaclient.events.ScoreboardRenderEvent;
...
import lol.magmaclient.ui.hud.impl.ScoreboardHud;
...
public class ModernInterfaces extends Module
{
    ...
    public ModernInterfaces() {
        ...
        this.scoreboardX = new NumberSetting("scoreboardX", (double) new ScaledResolution(Magma.mc).getScaledWidth() /2, -100000.0, 100000.0, 1.0E-5, a -> true);
        this.scoreboardY = new NumberSetting("scoreboardY", (double) new ScaledResolution(Magma.mc).getScaledHeight() /2, -100000.0, 100000.0, 1.0E-5, a -> true);
