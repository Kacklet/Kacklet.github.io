...
public class PopupAnimation extends Module
{
    ...
    public static boolean shouldScale(final GuiScreen gui) {
        return Magma.popupAnimation.isToggled() && ((gui instanceof ModernClickGui && PopupAnimation.clickGui.isEnabled()) || (gui instanceof GuiInventory && PopupAnimation.inventory.isEnabled()) || (gui instanceof GuiChest && PopupAnimation.chests.isEnabled()));
    }
    ...
    public void onGuiOpen(final GuiOpenEvent event) {
        if (Magma.mc.currentScreen == null && PopupAnimation.lastGuiTimer.hasTimePassed(150L)) {
    ...
    public static void doScaling() {
        ...
        final ScaledResolution res = new ScaledResolution(Magma.mc);
