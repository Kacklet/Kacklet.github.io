...
public class UpdateManager {
    ...
    public UpdateManager() {
        ...
        updateContext = new UpdateContext(
                ...
                UpdateTarget.deleteAndSaveInTheSameFolder(Magma.class),
                CurrentVersion.of(Integer.parseInt(Magma.VERSION_NUMBER)),
                Base64.getEncoder().encodeToString(Magma.MOD_ID.getBytes())
        );
